...
public class PivotArmIOSim implements PivotArmIO {
    public static class Constants {
        ...
        public static final double kArmLength = ARM_LENGTH; // Meters
    ...
    private PivotArmIO.State state = PivotArmIO.State.MANUAL;
    ...
    public void updateIO() {
        if (state == PivotArmIO.State.MANUAL) {
    ...
    @Override
    public PivotArmIO.State getState() {
        return state;
    }
}
