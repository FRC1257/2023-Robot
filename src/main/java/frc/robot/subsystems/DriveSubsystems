...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final Encoder m_leftEncoder =
      new Encoder(
          DriveConstants.kLeftEncoderPorts[0], //pins are being used right here
  ...
  public DriveSubsystem() {
    ...
    if (RobotBase.isSimulation()) { // If our robot is simulated
      ...
      m_leftEncoderSim = new EncoderSim(m_leftEncoder); //makes the simulated verisions of the encoders
      m_rightEncoderSim = new EncoderSim(m_rightEncoder);
      m_gyroSim = new ADXRS450_GyroSim(m_gyro);
      //this group of lines right here was why I was getting returned the pinsAlreadyUsed error
