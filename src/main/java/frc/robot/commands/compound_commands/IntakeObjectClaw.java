...
public class IntakeObjectClaw extends SequentialCommandGroup{
    public IntakeObjectClaw(PivotArm pivotarm, PivotWrist pivotwrist, Intake intake, IntakeArm intakeArm, Elevator elevator) {
        addCommands( //WITH INTAKE
            ...
            new ParallelCommandGroup(
                ...
                new SequentialCommandGroup(
                    ...
                    new IntakeWristPIDCommand(pivotwrist, Constants.IntakeWrist.INTAKE_SETPOINT_BOT)
                )
            )
        );
    }
